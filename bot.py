...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "main":
        ...
        user_histories[user_id] = []
        await query.edit_message_text(
            "Привет! Я ИИ-помощник компании «Красная Печать» 🤖\n\n"
            "Помогу подобрать всё что нужно для вашей свадьбы и рассчитаю стоимость. "
            "Если потребуется — передам вас живому менеджеру.\n\n"
